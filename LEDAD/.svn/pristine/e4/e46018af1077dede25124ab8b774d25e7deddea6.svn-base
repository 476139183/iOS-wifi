...
@implementation DYT_RegisteredPageview
...
-(void)setMyViewFrame{
    ...
    [_userNameTextField setValue:[UIFont boldSystemFontOfSize:10] forKeyPath:@"_placeholderLabel.font"];
    ...
    [_passWordTextField setValue:[UIFont boldSystemFontOfSize:10] forKeyPath:@"_placeholderLabel.font"];
    ...
    [_againPassWordTextField setPlaceholder:[Config DPLocalizedString:@"adedit_zc1"]];
    [_againPassWordTextField setValue:[UIFont boldSystemFontOfSize:10] forKeyPath:@"_placeholderLabel.font"];
    ...
    [_messageTextField setPlaceholder:[Config DPLocalizedString:@"Login_yzm"]];
    [_messageTextField setValue:[UIFont boldSystemFontOfSize:10] forKeyPath:@"_placeholderLabel.font"];
