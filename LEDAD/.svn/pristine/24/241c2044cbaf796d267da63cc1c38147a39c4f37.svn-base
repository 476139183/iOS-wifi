...
// 接收卡设置进度条
LDProgressView *receiveCardLDProgressView;
//瓶体连接进度条
LDProgressView *screenLinkingLDProgressView;
//逐点校正
LDProgressView *PWALDProgressView;
//在线升级
LDProgressView *onlineUpgradeLDProgressView;
