...
@property(nonatomic,retain) NSArray* imageViewArr; //拖动的视图数组
...
- (void) addImage:(NSString *)image //添加图片数据
{
...
//        UIImage* image = [_imageArray objectAtIndex:i];
        ...
        [imageView setImageWithURL:[NSURL URLWithString:[_imageArray objectAtIndex:i]] placeholderImage:[UIImage imageNamed:@"Icon"]];
