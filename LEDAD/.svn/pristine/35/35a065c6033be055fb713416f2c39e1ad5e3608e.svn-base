...
+(HMCustomSwitch *)switchWithLeftText:(NSString *)leftText andRight:(NSString *)rightText
{
    ...
    switchView.leftLabel.textColor = [UIColor redColor];
    switchView.rightLabel.textColor = [UIColor blackColor];
...
-(void)layoutSubviews
{
	...
	//	DLog(@"leftLabel=%@",NSStringFromCGRect(self.leftLabel.frame));
	...
	//	DLog(@"value=%f    xPos=%i",self.value,xPos);
	//	DLog(@"thumbWidth=%f    self.bounds.size.width=%f",thumbWidth,self.bounds.size.width);
}
...
{
	DLog(@"preendTrackingWithtouch");
	[super endTrackingWithTouch:touch withEvent:event];
	DLog(@"postendTrackingWithtouch");
	m_touchedSelf = YES;
