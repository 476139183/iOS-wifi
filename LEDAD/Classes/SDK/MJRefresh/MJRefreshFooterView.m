...
- (void)setState:(MJRefreshState)state
{
	...
	switch (state)
    {
        ...
        {
            _statusLabel.text = NSLocalizedString(@"MJRefreshFooterReleaseToRefresh", @"MJRefreshFooterReleaseToRefresh");
        ...
        {
            _statusLabel.text = NSLocalizedString(@"MJRefreshFooterPullToRefresh", @"MJRefreshFooterPullToRefresh");
            ...
            int currentCount = [self totalDatAccountInScrollView];
        ...
        {
            // 记录刷新前的数量
            NSInteger i = _lastRefreshCount;
            _lastRefreshCount = [self totalDatAccountInScrollView];
            if (i == _lastRefreshCount) {
                _statusLabel.text = NSLocalizedString(@"MJRefreshFooterEndLoad", @"MJRefreshFooterEndLoad");
            }else{
                _statusLabel.text = NSLocalizedString(@"MJRefreshFooterRefreshing", @"MJRefreshFooterRefreshing");
            }
            _arrowImage.transform = CGAffineTransformMakeRotation(M_PI);
            [UIView animateWithDuration:MJRefreshAnimationDuration animations:^{
                UIEdgeInsets inset = _scrollView.contentInset;
