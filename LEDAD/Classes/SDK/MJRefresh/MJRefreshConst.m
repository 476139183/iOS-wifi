...
//NSString *const MJRefreshFooterRefreshing = @"齐普光电正在帮你加载数据...";
//NSString *const MJRefreshLastTimeNotie = @"最后更新";
////NSString *const MJRefreshFooterEndLoad = NSLocalizedString(@"MJRefreshFooterEndLoad", @"数据已加载完毕");
//
//NSString *const MJRefreshHeaderPullToRefresh = @"下拉可以刷新";
//NSString *const MJRefreshHeaderReleaseToRefresh = @"松开立即刷新";
//NSString *const MJRefreshHeaderRefreshing = @"齐普光电正在帮你刷新...";
