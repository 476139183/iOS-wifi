...
-(UIButton*)deleteButton {
    if (!_deleteButton) {
        ...
        [_deleteButton setTitle:NSLocalizedString(@"adedit_CellOptionButton", nil) forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    self.imageView.bounds =CGRectMake(5,5,80,70);
    
    self.imageView.frame =CGRectMake(5,5,80,70);
