...
//    验证码框
    ...
    _loginButton.frame = CGRectMake(60, 200, 80, 30);
    ...
    _registeredButton.frame = CGRectMake(200, 200, 80, 30);
    ...
    [_registeredButton setTitle:[Config DPLocalizedString:@"NSString39"] forState:0];
